      ...
      <div className="px-4 py-8 space-y-8 animate-in fade-in slide-in-from-right-4 duration-500 pb-24">
        ...
        <div className="bg-gradient-to-br from-gray-900 to-black border border-white/5 rounded-[2.5rem] p-8 space-y-6 shadow-2xl">
           <div className="space-y-1">
              ...
              <p className="text-xl font-bold text-white tracking-tight">{bankDetails.bankName || 'Loading...'}</p>
           </div>
           ...
           <div className="space-y-1">
              ...
              <div className="flex items-center justify-between">
                ...
                <button 
                  ...
                  className="p-2 bg-blue-600/10 text-blue-400 disabled:opacity-40 rounded-lg active:scale-90 transition-all"
                >
                  <Icons.Copy size={16} />
                </button>
              </div>
           ...
           <div className="space-y-1">
              ...
              <p className="text-lg font-bold text-white uppercase">{bankDetails.accountName || 'Loading...'}</p>
           </div>
        </div>
