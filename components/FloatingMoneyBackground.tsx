...
export const FloatingMoneyBackground: React.FC = () => {
  return (
    <div className="pointer-events-none fixed inset-0 overflow-hidden z-20" aria-hidden="true">
      ...
      {/* Ambient Dark Blue & Indigo Glow Lights */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-80 h-80 bg-blue-600/10 rounded-full blur-3xl pointer-events-none"></div>
      <div className="absolute bottom-1/3 right-4 w-72 h-72 bg-indigo-600/15 rounded-full blur-3xl pointer-events-none"></div>
    </div>
  );
};
